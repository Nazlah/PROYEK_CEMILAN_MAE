            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form action="action_register.php" class="row g-3 needs-validation" novalidate method="POST">
                  ...
                  <div class="col-12">
                    ...
                    <div class="col-12">
                      <p class="small mb-0">Already have an account? <a href="login_pages.php">Log in</a></p>
                    </div>
                  </form>
