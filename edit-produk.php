    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link " data-bs-target="#forms-nav" data-bs-toggle="collapse" href="#">
          <i class="bi bi-journal-text"></i><span>Tabel</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
...
<div class="form-group mb-2">
    ...
    <input name="gambar_produk" id="gambar_produk" class="form-control" type="file" value="<?php echo $gambar; ?>" >
</div>

<div class="form-group mb-2">
    <label for="nama_produk">Nama Produk</label>
    <input name="nama" id="nama_produk" class="form-control" type="text" value="<?php echo $nama; ?>" placeholder="Nama Produk" required>
</div>


<div class="form-group mb-2">
    <label for="deskripsi_produk">Deskripsi Produk</label>
    <input name="deskripsi" id="deskripsi_produk" class="form-control" type="text" value="<?php echo $deskripsi; ?>" placeholder="Deskripsi Produk" required>
</div>
...
<div class="form-group mb-2">
    ...
    <input name="harga" id="harga_produk" class="form-control" type="number" value="<?= $harga ?>" placeholder="Harga Produk" required>
</div>
