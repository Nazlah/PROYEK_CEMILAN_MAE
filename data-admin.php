...
<head>
  ...
  <!-- Favicons -->
  <link href="penyimpanan/logo.png" rel="icon">
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="index.php" class="logo d-flex align-items-center">
        ...
        <span class="d-none d-lg-block">Data Admin</span>
      </a>
        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <a class="btn btn-primary mb-4" href="register-pages.php" >Tambah Admin</a>
                ...
                <table class="table datatable responsive-utilities">
                  ...
                  <tbody>
                    ...
                    foreach ($result as $admin) { ?>
                      <tr>
                        <th scope="row"><?php echo $i++; ?></th scope="row">
                        <td> <?php echo $admin['email']; ?></td>
                        <td>
                          <a href="delete-admin.php?id=<?php echo $admin[
                              'email'
