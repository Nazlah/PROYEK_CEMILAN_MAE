...
$query = "INSERT INTO produk
    (nama_produk, harga_produk, deskripsi_gambar, gambar_produk, rasa) VALUES ('{$nama_produk}','{$harga_produk}','{$deskripsi_produk}','{$filepath}','{$rasa}')";
